#!/usr/bin/env Rscript
# run_deseq2_M145.R
# DESeq2 differential expression analysis for S. coelicolor A3(2) M145 RNA-seq
# 3 conditions (M145_1, M145_2, M145_3) x 3 biological replicates = 9 samples
...
counts_file   <- "/Users/okaban/bioinfo/rna-seq/03_quantification/analysis/03_quant_260128_v1/counts/featureCounts_M145.txt"
sample_table  <- "/Users/okaban/bioinfo/rna-seq/03_quantification/analysis/03_quant_260128_v1/summary/quant_sample_table.tsv"

log_file <- file.path(deseq_run_dir, "logs", "deseq2_pipeline.log")
sink(log_file, split = TRUE)
cat("=== 04_deseq2 started at", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), "===\n")
...
# 7.5 Top variable genes heatmap
...
cat("\n=== 04_deseq2 COMPLETED at", format(Sys.time(), "%Y-%m-%d %H:%M:%S"), "===\n")
sink()
